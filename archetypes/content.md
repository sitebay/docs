...
1.  If you have not already done so, create a SiteBay account and WordPress Site. See our [Getting Started on the SiteBay Platform](/docs/products/platform/get-started/) and Create a WordPress Site.
