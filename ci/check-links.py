                ...
                if file.endswith(".md"):
                    try:
                        ...
                        if (
                            ...
                            canonical_link = (
                                "/docs/guides/" + expanded_guide["slug"] + "/"
                            )
                        # ... If the guide is in the API section...
                        elif (
                            "slug" in expanded_guide.keys() and "docs/api/" in file_path
                        ):
                        ...
                        guide = Guide(
                            root, file_path, expanded_guide["title"], canonical_link
                        )
                    ...
                    if (
                        next(
                            (
                                x
                                for x in guides
                                if link.replace("/docs/", "/") in x.aliases
                            ),
                            None,
                        )
                        is not None
