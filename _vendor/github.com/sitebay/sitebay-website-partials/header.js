(() => {
  ...
  var mount2 = function() {
    ...
    if ($notification) {
      let api_url = "https://www.sitebay.org/wp-json/sitebay/v1/header-notification", lang = getLanguageString();
      if (lang) {
        api_url = `https://www.sitebay.org/${lang}/wp-json/sitebay/v1/header-notification?lang=${lang}`;
      }
  ...
  var $html3;
  var mount3 = function() {
    let api_url = "https://www.sitebay.org/wp-json/sitebay/v1/header-featured", lang = getLanguageString();
    if (lang) {
      api_url = `https://www.sitebay.org/${lang}/wp-json/sitebay/v1/header-featured?lang=${lang}`;
    }
