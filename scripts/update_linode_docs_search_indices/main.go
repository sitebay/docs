...
func (config) Version() string {
	return "update_sitebay_docs_search_indices " + version
}
...
// Usage:
//
//     ALGOLIA_ADMIN_API_KEY=<mysecret> update_sitebay_docs_search_indices --sourcedir ../../public
//
...
func main() {
	...
	indices := []algoliaIndex{
		...
		algoliaIndex{
			name: "sitebay-marketplace" + cfg.IndexSuffix,
		...
		algoliaIndex{
			name: "sitebay-resources" + cfg.IndexSuffix,
